...
namespace DeviceExplorer.Utilities
{
    public class PropertyGridDataProvider : IListSource
    {
        ...
        public virtual PropertyGridProperty CreateProperty() => new(this);
        ...
        protected virtual void Describe(PropertyGridProperty property, PropertyDescriptor descriptor)
        {
            ...
            {
                property.DisplayName = Decamelizer.Decamelize(property.DisplayName);
            }
        ...
        public virtual PropertyGridProperty CreateProperty(PropertyDescriptor descriptor)
        {
            ...
            property.RefreshValueFromDescriptor(DictionaryObjectPropertySetOptions.TrackChanges);
            return property;
        }

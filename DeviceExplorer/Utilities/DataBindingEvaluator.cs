...
namespace DeviceExplorer.Utilities
{
    public static class DataBindingEvaluator
    {
        ...
        public static object Eval(object container, string expression) => Eval(container, expression, true);
        ...
        public static object GetPropertyValue(object container, string propName) => GetPropertyValue(container, propName, true);
        ...
        public static object GetIndexedPropertyValue(object container, string expression) => GetIndexedPropertyValue(container, expression, true);
